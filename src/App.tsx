      ...
      <div className="app-wrapper">
        ...
        <div className="app-section__row">
          ...
          <div className="app-section__column">
            <p>
              I'm working remotely as a Senior Product Designer at <a href="https://quicknode.com/" target="_blank" className="app-section__yellow-link">QuickNode</a>. We make blockchain development simple and approachable for everyone. Web3 is powered by QuickNode.
              <br />
              <br />
        ...
        <div className="app-section__row">
          ...
          <div className="app-section__column">
            <p>
              I want to continue learning and design more than just things that live on the internet. The possiblity of designing homes, furniture, houseware, and clothing is very exciting to me.
              <br />
              <br />
